...
export class RoutineDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('jhipsterhelloreactApp.routine.delete.question'));
...
export default class RoutineComponentsPage {
  ...
  async deleteRoutine() {
    ...
    expect(await routineDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/jhipsterhelloreactApp.routine.delete.question/);
