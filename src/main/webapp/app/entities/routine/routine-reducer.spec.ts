...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './routine.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROUTINE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ROUTINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ROUTINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ROUTINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ROUTINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ROUTINE actions', async () => {
      const expectedActions = [
        {
