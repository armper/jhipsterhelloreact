...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './excercise.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXCERCISE_LIST actions', async () => {
    ...
    it('dispatches FETCH_EXCERCISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXCERCISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXCERCISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXCERCISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXCERCISE actions', async () => {
      const expectedActions = [
        {
