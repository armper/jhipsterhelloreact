...
export const CycleDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterhelloreactApp.cycle.delete.question">Are you sure you want to delete this Cycle?</ModalBody>
      <ModalFooter>
